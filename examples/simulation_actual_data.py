...
if __name__ == '__main__':
    ...
    # synthesizing and sequencing simulation of YYC coded sequences,
    ...
    bloom_filter = bloom.Filter(inform_count=len(yycpdf_dna), hash_function_type="FNV1a")
    for depth in [1000]:
        error_counter = ErrorCounterOneFile(bloom_filter, expected_rate=0.001, payload_length=120, digital_count=None,
                                            ...
                                            seed=30, actual_dnas=True,  training_dnas=yycpdf_dna,
                                            checking_dnas=yycpdf_dna, training_name=training_name,
