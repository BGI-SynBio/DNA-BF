...
def output(info_type=0, class_name=None, method_name=None, info=None, warn_terminate=False):
    ...
    :param info_type: Type of information.
                      We have declared three types available now: NORMAL, WARN, and ERROR. If the type is ERROR,
                      we will end this program immediately.
    ...
    :param method_name: Current method name, used to locate the source of the information.
                         It is easy to get it by method "str(sys._getframe().f_code.co_name)" in the classes you need to
    ...
    if info_type == NORMAL:
        ...
        print("\033[1;32;0m" + string + "\033[0m", flush=True)
        if warn_terminate:
            exit(1)
    elif info_type == ERROR:
        # Print red and high light.
        print("\033[1;31;0m" + string + "\033[0m", flush=True)
        # End the program immediately.
        exit(1)
    else:
        # Print red and high light.
        print("\033[1;31;0m" + "Info type is wrong" + "\033[0m", flush=True)
        # End the program immediately.
        exit(1)
